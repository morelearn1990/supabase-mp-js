...
export default class GoTrueClient {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('code' in credentials) {
                    ...
                    res = yield _request(this.fetch, 'GET', `${this.url}/wechat_mini/login?code=${code}`, {
    ...
    wechatBindPhone(credentials) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('code' in credentials) {
                    const { code } = credentials;
                    const { data, error: userError } = yield _request(this.fetch, 'GET', `${this.url}/wechat_mini/bind_phone?code=${code}`, {
                        headers: this.headers,
    ...
    wechatBindAccount(credentials) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('code' in credentials) {
                    const { code } = credentials;
                    const { data, error: userError } = yield _request(this.fetch, 'GET', `${this.url}/wechat_mini/bind_account?code=${code}`, {
                        headers: this.headers,
                        jwt: session.access_token,
                        xform: _userResponse,
                    });
    ...
    getUnlimitedQRCode(credentials) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res = yield _request(this.fetch, 'POST', `${this.url}/wechat_mini/unlimited_qrcode`, {
                    headers: this.headers,
                    // xform: _sessionResponse,
                    body: {
                        page,
    ...
    signOut() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (accessToken) {
                const { error } = yield _request(this.fetch, 'POST', `${this.url}/logout`, {
                    headers: Object.assign(Object.assign({}, this.headers), { Authorization: `Bearer ${accessToken}` }),
                    noResolveJson: true,
                });
                if (error) {
