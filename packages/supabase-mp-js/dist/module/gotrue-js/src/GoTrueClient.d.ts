...
export default class GoTrueClient {
     ...
     */
    protected _recoverAndRefresh(): Promise<void>;
    private _callRefreshToken;
    protected _notifyAllSubscribers(event: AuthChangeEvent, session: Session | null): void;
    /**
     * set currentSession and currentUser
     * process to _startAutoRefreshToken if possible
     */
    protected _saveSession(session: Session): Promise<void>;
    private _persistSession;
    protected _removeSession(): Promise<void>;
    /**
