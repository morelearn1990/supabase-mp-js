...
class SupabaseClient {
    ...
    constructor(supabaseUrl, supabaseKey, options) {
        ...
        const defaultStorageKey = `sb-${(_b = (_a = this.authUrl.match(/:\/\/(.+?)(\/|$)/)) === null || _a === void 0 ? void 0 : _a[1]) === null || _b === void 0 ? void 0 : _b.split('.')[0]}-auth-token`;
        const DEFAULTS = {
        ...
        this.storageKey = (_d = (_c = settings.auth) === null || _c === void 0 ? void 0 : _c.storageKey) !== null && _d !== void 0 ? _d : '';
        this.headers = (_f = (_e = settings.global) === null || _e === void 0 ? void 0 : _e.headers) !== null && _f !== void 0 ? _f : {};
        this.auth = this._initSupabaseAuthClient((_g = settings.auth) !== null && _g !== void 0 ? _g : {}, this.headers, (_h = settings.global) === null || _h === void 0 ? void 0 : _h.fetch);
        this.fetch = (0, fetch_1.fetchWithAuth)(supabaseKey, this._getAccessToken.bind(this), (_j = settings.global) === null || _j === void 0 ? void 0 : _j.fetch);
        this.realtime = this._initRealtimeClient(Object.assign({ headers: this.headers }, settings.realtime));
        this.rest = new index_2.PostgrestClient(`${_supabaseUrl}/rest/v1`, {
            headers: this.headers,
            schema: (_k = settings.db) === null || _k === void 0 ? void 0 : _k.schema,
            fetch: this.fetch,
        });
