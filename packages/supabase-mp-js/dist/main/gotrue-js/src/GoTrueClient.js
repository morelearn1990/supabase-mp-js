...
const poly_url_1 = require("../../lib/poly-url");
...
class GoTrueClient {
    ...
    signOut() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (accessToken) {
                const { error } = yield (0, fetch_1._request)(this.fetch, 'POST', `${this.url}/logout`, {
    ...
    _getUrlForProvider(provider, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.queryParams) {
            const query = new poly_url_1.URLSearchParams(options.queryParams);
