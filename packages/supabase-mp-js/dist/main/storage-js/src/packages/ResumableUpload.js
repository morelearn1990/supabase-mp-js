...
exports.uploadLargeFile = void 0;
 ...
 */
function uploadLargeFile(supabaseUrl, headers, filePath, bucketName, objectName, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (createRes.statusCode !== 201) {
            throw new errors_1.StorageError(createRes.data || 'Failed to create upload session');
        }
        // Get Upload URL from Location header
        let uploadUrl = createRes.header['Location'] || createRes.header['location'];
        if (!uploadUrl) {
            throw new errors_1.StorageError('No Location header in TUS response');
        }
        ...
        while (offset < fileSize) {
            ...
            yield retry(() => __awaiter(this, void 0, void 0, function* () {
                ...
                if (patchRes.statusCode !== 204) {
                    ...
                    throw new errors_1.StorageError(`Upload failed at offset ${offset}: ${patchRes.statusCode}`);
                }
            }));
            // Advance offset
